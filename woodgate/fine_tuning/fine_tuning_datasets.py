...
class FineTuningDatasets:
    ...
    training_data = pd.read_csv(BuildConfiguration.TRAINING_PATH)
    ...
    testing_data = pd.read_csv(BuildConfiguration.TESTING_PATH)
    ...
    validation_data = pd.read_csv(BuildConfiguration.VALIDATION_PATH)
    ...
    regression_data = pd.read_csv(BuildConfiguration.REGRESSION_PATH)
    ...
    def create_intents_data_json():
        ...
        :rtype:
        """
        intents_data_json = os.path.join(FineTuningDatasets.DATASET_SUMMARY_DIR, "intentsData.json")
        with open(intents_data_json) as file:
            file.write(json.dumps(FineTuningDatasets.intents_data))
    ...
    def create_intents_bar_plots():
        ...
        axs.barh(FineTuningDatasets.testing_intents_list, FineTuningDatasets.testing_intents_counts)
        plt.tight_layout()
        plt.savefig(os.path.join(FineTuningDatasets.DATASET_SUMMARY_DIR, "intents_bar_plot_testing.png"))
        plt.figure().clear()

        fig, axs = plt.subplots()
        axs.title.set_text("Training set")
        axs.barh(FineTuningDatasets.training_intents_list, FineTuningDatasets.training_intents_counts)
        plt.tight_layout()
        plt.savefig(os.path.join(FineTuningDatasets.DATASET_SUMMARY_DIR, "intents_bar_plot_training.png"))
        plt.figure().clear()

        fig, axs = plt.subplots()
        axs.title.set_text("Validation set")
        axs.barh(FineTuningDatasets.validation_intents_list, FineTuningDatasets.validation_intents_counts)
        plt.tight_layout()
        plt.savefig(os.path.join(FineTuningDatasets.DATASET_SUMMARY_DIR, "intents_bar_plot_validation.png"))
        plt.figure().clear()

        fig, axs = plt.subplots()
        axs.title.set_text("Regression set")
        axs.barh(FineTuningDatasets.regression_intents_list, FineTuningDatasets.regression_intents_counts)
        plt.tight_layout()
        plt.savefig(os.path.join(FineTuningDatasets.DATASET_SUMMARY_DIR, "intents_bar_plot_regression.png"))
        plt.figure().clear()
    ...
    def create_intents_venn_diagrams():
        ...
        venn2(
            [
                FineTuningDatasets.training_intents_set,
                FineTuningDatasets.validation_intents_set,
            ],
            ("Training", "Validation")
        )
        plt.title("Datasets - Intents Venn Diagram - Training and Validation")
        plt.tight_layout()
        plt.savefig(os.path.join(FineTuningDatasets.DATASET_SUMMARY_DIR, "intents_venn_training_validation.png"))
        plt.figure().clear()
        ...
        venn2(
            [
                FineTuningDatasets.training_intents_set,
                FineTuningDatasets.testing_intents_set,
            ],
            ("Training", "Testing")
        )
        plt.title("Datasets - Intents Venn Diagram - Training and Testing")
        plt.tight_layout()
        plt.savefig(os.path.join(FineTuningDatasets.DATASET_SUMMARY_DIR, "intents_venn_training_testing.png"))
        plt.figure().clear()
        ...
        venn2(
            [
                FineTuningDatasets.training_intents_set,
                FineTuningDatasets.regression_intents_set,
            ],
            ("Training", "Regression")
        )
        plt.title("Datasets - Intents Venn Diagram - Training and Regression")
        plt.tight_layout()
        plt.savefig(os.path.join(FineTuningDatasets.DATASET_SUMMARY_DIR, "intents_venn_training_regression.png"))
        plt.figure().clear()
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(FineTuningDatasets.DATASET_SUMMARY_DIR, "intents_venn_validation_testing.png"))
        plt.figure().clear()
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(FineTuningDatasets.DATASET_SUMMARY_DIR, "intents_venn_validation_regression.png"))
        plt.figure().clear()
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(FineTuningDatasets.DATASET_SUMMARY_DIR, "intents_venn_testing_regression.png"))
        plt.figure().clear()
