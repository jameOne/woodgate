...
class TestWoodgateSettingsDefaults(unittest.TestCase):
    ...
    def test_default_values(self) -> None:
        ...
        # )
        #
        # # make sure create build_history visuals attr has a value
        # self.assertEqual(
        ...
        # )
        #
        # # make sure build_history dir has a directory for data
        # self.assertEqual(
        ...
        # )
        #
        # # make sure evaluator build_history dir has a directory for the
        # # specific evaluator version
        # self.assertEqual(
        ...
        # )
        #
        # # make sure evaluator data dir has a directory for the
        # # specific evaluator version
        # self.assertEqual(
        ...
        #     "bert_model.ckpt"
        #
        # # make sure there is a value for bert evaluator
        # self.assertEqual(
        #     WoodgateSettings.bert_model_file,
        #     exp_bert_model_file
        # )
        #
        # # make sure there is a value for bert evaluator path
        # self.assertEqual(
