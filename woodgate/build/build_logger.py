...
class BuildLogger:
    ...
    def __init__(self, build_configuration: BuildConfiguration):
        ...
        self.log_dir: str = os.getenv("LOG_DIR", os.path.join(
            build_configuration.output_dir, "log", build_configuration.build_version))
        ...
        self.log_file: str = os.getenv("LOG_FILE", f"{build_configuration.build_version}.log")
