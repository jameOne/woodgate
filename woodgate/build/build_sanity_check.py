"""
build_sanity_check.py - The build_sanity_check.py module contains
...
from ..fine_tuning.fine_tuning_text_processor import \
    FineTuningTextProcessor


class BuildSanityCheck:
    """
    BuildSanityCheck - The BuildSanityCheck class encapsulates
    ...
    def __init__(
        ...
        """
        self.model_build_dir = \
            model_storage_strategy.model_build_dir
