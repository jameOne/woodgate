...
class FileSystemConfiguration:
    ...
    woodgate_base_dir: str = os.getenv(
        "WOODGATE_BASE_DIR",
        os.path.join(os.path.expanduser("~"), "woodgate")
    )
    ...
    data_dir: str = os.getenv("DATA_DIR", os.path.join(
        woodgate_base_dir, "data"))
    ...
    #: create `DATASET_SUMMARY_DIR` if it does not already
    #: exist.
